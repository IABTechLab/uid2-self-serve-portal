    ...
    <div className='terms-and-conditions'>
      <div className='terms-container' onScroll={handleScroll}>
        ...
        <p>
          ...
          the UID2 Sharing Portal (“<span className='terms-bold'>Portal</span>”), which is designed
          to enable users to share UID2s with third-party participants designated through the
          Portal. You may only use the Portal in connection with performing work for a company
          (each, a “<span className='terms-bold'>Company</span>”) that has entered into an
          agreement(s) with TD (as defined below) to participate in a proof-of-concept trial of the
          UID2 technology (the “<span className='terms-bold'>POC Agreement</span>”). For purposes of
          these Terms, “<span className='terms-bold'>TD</span>” will mean (a) The Trade Desk, Inc.
          if Company is domiciled in the United States, or (b) the UK Trade Desk Limited if Company
          is domiciled in any country or territory outside of the United States.
        </p>
        <p>
        ...
        <p>
          ...
          behalf of such party that has entered into that certain POC Agreement, and are authorized
          to bind such party to these Terms and your use of the Portal; and (3) you have obtained
          all necessary rights, licenses, and approvals in your use of the Portal and you will
          provide only accurate information when using the Portal.
        </p>
        <h2>2 User Account and Account Security</h2>
        <p>
          When you register for an account through the Portal (the “
          <span className='terms-bold'>Account</span>”), you will need to provide required
          information and complete all required steps. You must own, control or have all necessary
          rights to provide all account information for yourself and others, including but not
          limited to email addresses. We may send verification codes and other administrative
          messages to the contact information you use to register for your Account. You are solely
          responsible for protecting access to your Account, and you should not otherwise share your
          login or password to your Account with any third party. Account creation is subject to
          TD’s approval, in its sole discretion.
        </p>
            ...
            <tr>
              ...
              <td>
                ...
                <ul>
                  ...
                  <li>
                    Modify the Portal, remove any proprietary rights notices or markings, or
                    otherwise make any derivative works based upon the Portal;
                  </li>
                  <li>
                    ...
                    Portal or that could damage, disable, overburden or impair the functioning of
                    the Portal in any manner;
                  </li>
                  <li>
                  ...
                  <li>
                    Use the Portal for any illegal or unauthorized purpose in contravention of the
                    POC Agreement, or engage in, encourage or promote any activity that violates
                    these Terms.
                  </li>
                </ul>
              </td>
        ...
        <p>
          ...
          <span className='terms-bold'>Feedback</span>”). You understand that TD may use such
          Feedback for any purpose, commercial or otherwise, without acknowledgment or compensation
          to you, including to develop, copy, publish, or improve the Feedback in TD’s sole
          discretion. You understand that TD may treat Feedback as nonconfidential.
        </p>
        ...
        <p>
          ...
          arising out of or related to your violation of these Terms. Company agrees to pay all
          fees, costs and expenses associated with defending Claims (including attorneys’ fees) and
          will cooperate with the TD Parties in defending such Claims. Company also agrees that TD
          Parties will have control of the defense or settlement, at TD’s sole option, of any
          third-party Claims. This indemnity is in addition to, and not in lieu of, any other
          indemnities set forth in a written agreement between Company and TD or the other TD
          Parties (including any POC Agreement).
        </p>
        <h2>7 Disclaimers</h2>
        <p className='terms-bold'>
          Your use of the Portal is at your sole risk. The Portal and any content therein are
          ...
          purpose, title, and non-infringement. In addition, TD does not represent or warrant that
          the Portal is accurate, complete, reliable, current or error-free.
        </p>
        ...
        <p className='terms-bold'>
          <table>
            ...
            <tr>
              <td>(b)</td>
              <td>
                The total liability of TD and the TD Parties for any claim arising out of or
                relating to these Terms or the Portal, regardless of the form of the action, is
                limited to the amount Company or you has paid (if any) to use the Portal.
              </td>
            </tr>
            <tr>
              <td>(c)</td>
        ...
        <p>
          ...
          of the Portal at any time. You also have the right to stop using the Portal at any time.
          We are not responsible for any loss or harm related to your inability to access or use the
          Portal.
        </p>
        <h2>11 Amendments</h2>
        <p>
          ...
          immediately, and your continued use of the Portal after TD provides such notice will
          confirm acceptance of the changes. If you or Company do not agree to the amended Terms,
          you must stop using the Portal.
        </p>
        ...
        <p>
          ...
          person or entity. You agree that communications and transactions between you and TD may be
