...
export function errorHandler<P extends ErrorBoundaryPropType>(
  ...
  class ErrorHandlerWrapperComponent extends React.Component<P, ErrorState> {
    ...
    constructor(props: P) {
      super(props);
      this.state = {
        errorId: uuidv4() as string, // eslint-disable-line @typescript-eslint/no-unsafe-call
        errorCount: 0,
        hasError: false,
        errorHash: undefined,
      };
    ...
    componentDidCatch(error: Error, info: ErrorInfo) {
      const errorId = uuidv4() as string; // eslint-disable-line @typescript-eslint/no-unsafe-call
    ...
    render() {
      const { hasError, errorId, errorHash, errorCount, message, stack, componentStack } =
        this.state;
