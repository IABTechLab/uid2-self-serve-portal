...
14. Verify that you have followed the instructions in [Keycloak Advanced Setup](./KeycloakAdvancedSetup.md) to ensure you have the proper permissions within the portal.
